...
for z in range(10000):
    ...
    report_table_1_changed = report_table_1[6:]
    ...
    report_table_2_changed_2 = report_table_2[3:]
    ...
    report_table_3_changed_2 = report_table_2[2:]
    ...
    report_table_5_changed_1 = report_table_1[1:]
    report_table_5_changed_3 = report_table_3[2:]
    ...
    report_table_6_changed_3 = report_table_3[1:]
    ...
    report_table_7_changed_1 = report_table_1[4:]
    report_table_7_changed_3 = report_table_3[1:]
    ...
    report_table_9_changed_1 = report_table_1[1:]
    report_table_9_changed_2 = report_table_2[1:]
    report_table_9_changed_4 = report_table_4[1:]
    ...
    for i in report_table_9_changed_4:
        if i[0] in player_list_9:
            report_table_9_changed_4.remove(i)
    for i in range(len(outcome9_list)):
        for j in range(1, (len(outcome9_list) - i)):
            if outcome9_list[i][0] == outcome9_list[i + j][0] != 0:
                ...
                elif outcome9_list[i + j][1] == 4:
                    outcome9_list[i + j] = report_table_9_changed_4[0]
                    report_table_9_changed_4.remove(report_table_9_changed_4[0])
    for i in outcome9_list:
        value_9 = value_9 + i[3]
    ...
    report_table_10_changed_1 = report_table_1[3:]
    ...
    report_table_12_changed_5 = report_table_5[1:]
    for i in report_table_12_changed_1:
        if i[0] in player_list_12:
            report_table_12_changed_1.remove(i)
    for i in report_table_12_changed_5:
        if i[0] in player_list_12:
            report_table_12_changed_5.remove(i)
    for i in range(len(outcome12_list)):
        for j in range(1, (len(outcome12_list) - i)):
            if outcome12_list[i][0] == outcome12_list[i + j][0] != 0:
                ...
                elif outcome12_list[i + j][1] == 5:
                    outcome12_list[i + j] = report_table_12_changed_5[0]
                    report_table_12_changed_5.remove(report_table_12_changed_5[0])
    for i in outcome12_list:
        value_12 = value_12 + i[3]

    # outcome for 6+1
    value_13 = 0
    outcome13_list = [report_table_6[0], report_table_1[0]]
    player_list_13 = []
    for i in outcome13_list:
        if i[0] != 0:
            player_list_13.append(i[0])
    report_table_13_changed_1 = report_table_1[2:]
    report_table_13_changed_6 = report_table_6[1:]
    for i in report_table_13_changed_1:
        if i[0] in player_list_13:
            report_table_13_changed_1.remove(i)
    for i in report_table_13_changed_6:
        if i[0] in player_list_13:
            report_table_13_changed_6.remove(i)
    for i in range(len(outcome13_list)):
        for j in range(1, (len(outcome13_list) - i)):
            if outcome13_list[i][0] == outcome13_list[i + j][0] != 0:
                ...
                elif outcome13_list[i + j][1] == 6:
                    outcome13_list[i + j] = report_table_13_changed_6[0]
                    report_table_13_changed_6.remove(report_table_13_changed_6[0])
    for i in outcome13_list:
        value_13 = value_13 + i[3]

    # outcome for 7
    value_14 = 0
    outcome14_list = [report_table_7[0]]
    player_list_14 = []
    for i in outcome14_list:
        if i[0] != 0:
            player_list_14.append(i[0])
    report_table_14_changed_7 = report_table_7[1:]
    for i in report_table_14_changed_7:
        if i[0] in player_list_14:
            report_table_14_changed_7.remove(i)
    for i in range(len(outcome14_list)):
        for j in range(1, (len(outcome14_list) - i)):
            if outcome14_list[i][0] == outcome14_list[i + j][0] != 0:
                if outcome14_list[i + j][1] == 7:
                    outcome14_list[i + j] = report_table_14_changed_7[0]
                    report_table_14_changed_7.remove(report_table_14_changed_7[0])
    for i in outcome14_list:
                ...
                if m == a:
                    for p in outcome_m:
                        if p[0] == 1:
                            ...
                            sereport_table_1_changed = sereport_table_1[6:]
                            ...
                            sereport_table_2_changed_2 = sereport_table_2[3:]
                            ...
                            sereport_table_3_changed_2 = sereport_table_2[2:]
                            ...
                            sereport_table_5_changed_1 = sereport_table_1[1:]
                            sereport_table_5_changed_3 = sereport_table_3[2:]
                            ...
                            sereport_table_6_changed_3 = sereport_table_3[1:]
                            ...
                            sereport_table_7_changed_1 = sereport_table_1[4:]
                            sereport_table_7_changed_3 = sereport_table_3[1:]
                            ...
                            sereport_table_8_changed_4 = sereport_table_4[1:]
                            for i in sereport_table_8_changed_3:
                                if i[0] in seplayer_list_8:
                                    sereport_table_8_changed_3.remove(i)
                            for i in sereport_table_8_changed_4:
                                if i[0] in seplayer_list_8:
                                    sereport_table_8_changed_4.remove(i)
                            for i in range(len(seoutcome8_list)):
                                for j in range(1, (len(seoutcome8_list) - i)):
                                    if (
                                        ...
                                        elif seoutcome8_list[i + j][1] == 4:
                                            seoutcome8_list[
                                                i + j
                                            ] = sereport_table_8_changed_4[0]
                                            sereport_table_8_changed_4.remove(
                                                sereport_table_8_changed_4[0]
                                            )
                            for i in seoutcome8_list:
                            ...
                            sereport_table_9_changed_1 = sereport_table_1[1:]
                            sereport_table_9_changed_2 = sereport_table_2[1:]
                            sereport_table_9_changed_4 = sereport_table_4[1:]
                            ...
                            for i in sereport_table_9_changed_4:
                                if i[0] in seplayer_list_9:
                                    sereport_table_9_changed_4.remove(i)
                            for i in range(len(seoutcome9_list)):
                                for j in range(1, (len(seoutcome9_list) - i)):
                                    if (
                                        ...
                                        elif seoutcome9_list[i + j][1] == 4:
                                            seoutcome9_list[
                                                i + j
                                            ] = sereport_table_9_changed_4[0]
                                            sereport_table_9_changed_4.remove(
                                                sereport_table_9_changed_4[0]
                                            )
                            for i in seoutcome9_list:
                            ...
                            sereport_table_10_changed_1 = sereport_table_1[3:]
                            ...
                            sereport_table_11_changed_2 = sereport_table_2[1:]
                            sereport_table_11_changed_5 = sereport_table_5[1:]
                            for i in sereport_table_11_changed_2:
                                if i[0] in seplayer_list_11:
                                    sereport_table_11_changed_2.remove(i)
                            for i in sereport_table_11_changed_5:
                                if i[0] in seplayer_list_11:
                                    sereport_table_11_changed_5.remove(i)
                            for i in range(len(seoutcome11_list)):
                                for j in range(1, (len(seoutcome11_list) - i)):
                                    if (
                                        ...
                                        elif seoutcome11_list[i + j][1] == 5:
                                            seoutcome11_list[
                                                i + j
                                            ] = sereport_table_11_changed_5[0]
                                            sereport_table_11_changed_5.remove(
                                                sereport_table_11_changed_5[0]
                                            )
                            for i in seoutcome11_list:
                            ...
                            sereport_table_12_changed_5 = sereport_table_5[1:]
                            for i in sereport_table_12_changed_1:
                                if i[0] in seplayer_list_12:
                                    sereport_table_12_changed_1.remove(i)
                            for i in sereport_table_12_changed_5:
                                if i[0] in seplayer_list_12:
                                    sereport_table_12_changed_5.remove(i)
                            for i in range(len(seoutcome12_list)):
                                for j in range(1, (len(seoutcome12_list) - i)):
                                    if (
                                        ...
                                        elif seoutcome12_list[i + j][1] == 5:
                                            seoutcome12_list[
                                                i + j
                                            ] = sereport_table_12_changed_5[0]
                                            sereport_table_12_changed_5.remove(
                                                sereport_table_12_changed_5[0]
                                            )
                            for i in seoutcome12_list:
                            ...
                            sereport_table_13_changed_1 = sereport_table_1[2:]
                            sereport_table_13_changed_6 = sereport_table_6[1:]
                            for i in sereport_table_13_changed_1:
                                if i[0] in seplayer_list_13:
                                    sereport_table_13_changed_1.remove(i)
                            for i in sereport_table_13_changed_6:
                                if i[0] in seplayer_list_13:
                                    sereport_table_13_changed_6.remove(i)
                            for i in range(len(seoutcome13_list)):
                                for j in range(1, (len(seoutcome13_list) - i)):
                                    if (
                                        ...
                                        elif seoutcome13_list[i + j][1] == 6:
                                            seoutcome13_list[
                                                i + j
                                            ] = sereport_table_13_changed_6[0]
                                            sereport_table_13_changed_6.remove(
                                                sereport_table_13_changed_6[0]
                                            )
                            for i in seoutcome13_list:
                            ...
                            # outcome for 7
                            sevalue_14 = 0
                            seoutcome14_list = [sereport_table_7[0]]
                            seplayer_list_14 = []
                            for i in seoutcome14_list:
                                if i[0] != 0:
                                    seplayer_list_14.append(i[0])
                            sereport_table_14_changed_7 = sereport_table_7[1:]
                            for i in sereport_table_14_changed_7:
                                if i[0] in seplayer_list_14:
                                    sereport_table_14_changed_7.remove(i)
                            for i in range(len(seoutcome14_list)):
                                for j in range(1, (len(seoutcome14_list) - i)):
                                    if (
                                        ...
                                        if seoutcome14_list[i + j][1] == 7:
                                            seoutcome14_list[
                                                i + j
                                            ] = sereport_table_14_changed_7[0]
                                            sereport_table_14_changed_7.remove(
                                                sereport_table_14_changed_7[0]
                                            )
                            for i in seoutcome14_list:
    ...
    random_table_1_changed = random_table_1[6:]
    ...
    random_table_2_changed_2 = random_table_2[3:]
    ...
    random_table_3_changed_2 = random_table_2[2:]
    ...
    random_table_5_changed_1 = random_table_1[1:]
    random_table_5_changed_3 = random_table_3[2:]
    ...
    random_table_6_changed_3 = random_table_3[1:]
    ...
    random_table_7_changed_1 = random_table_1[4:]
    random_table_7_changed_3 = random_table_3[1:]
    ...
    random_table_8_changed_4 = random_table_4[1:]
    for i in random_table_8_changed_3:
        if i[0] in random_player_list_8:
            random_table_8_changed_3.remove(i)
    for i in random_table_8_changed_4:
        if i[0] in random_player_list_8:
            random_table_8_changed_4.remove(i)
    for i in range(len(random_outcome8_list)):
        for j in range(1, (len(random_outcome8_list) - i)):
            if random_outcome8_list[i][0] == random_outcome8_list[i + j][0] != 0:
                if random_outcome8_list[i + j][1] == 3:
                    random_outcome8_list[i + j] = random_table_8_changed_3[0]
                    random_table_8_changed_3.remove(random_table_8_changed_3[0])
                elif random_outcome8_list[i + j][1] == 4:
                    random_outcome8_list[i + j] = random_table_8_changed_4[0]
                    random_table_8_changed_4.remove(random_table_8_changed_4[0])
    for i in random_outcome8_list:
    ...
    random_table_9_changed_1 = random_table_1[1:]
    random_table_9_changed_2 = random_table_2[1:]
    random_table_9_changed_4 = random_table_4[1:]
    ...
    for i in random_table_9_changed_4:
        if i[0] in random_player_list_9:
            random_table_9_changed_4.remove(i)
    for i in range(len(random_outcome9_list)):
        for j in range(1, (len(random_outcome9_list) - i)):
            if random_outcome9_list[i][0] == random_outcome9_list[i + j][0] != 0:
                ...
                elif random_outcome9_list[i + j][1] == 4:
                    random_outcome9_list[i + j] = random_table_9_changed_4[0]
                    random_table_9_changed_4.remove(random_table_9_changed_4[0])
    for i in random_outcome9_list:
    ...
    random_table_10_changed_1 = random_table_1[3:]
    ...
    random_table_11_changed_2 = random_table_2[1:]
    random_table_11_changed_5 = random_table_5[1:]
    for i in random_table_11_changed_2:
        if i[0] in random_player_list_11:
            random_table_11_changed_2.remove(i)
    for i in random_table_11_changed_5:
        if i[0] in random_player_list_11:
            random_table_11_changed_5.remove(i)
    for i in range(len(random_outcome11_list)):
        for j in range(1, (len(random_outcome11_list) - i)):
            if random_outcome11_list[i][0] == random_outcome11_list[i + j][0] != 0:
                if random_outcome11_list[i + j][1] == 2:
                    random_outcome11_list[i + j] = random_table_11_changed_2[0]
                    random_table_11_changed_2.remove(random_table_11_changed_2[0])
                elif random_outcome11_list[i + j][1] == 5:
                    random_outcome11_list[i + j] = random_table_11_changed_5[0]
                    random_table_11_changed_5.remove(random_table_11_changed_5[0])
    for i in random_outcome11_list:
    ...
    random_table_12_changed_5 = random_table_5[1:]
    for i in random_table_12_changed_1:
        if i[0] in random_player_list_12:
            random_table_12_changed_1.remove(i)
    for i in random_table_12_changed_5:
        if i[0] in random_player_list_12:
            random_table_12_changed_5.remove(i)
    for i in range(len(random_outcome12_list)):
        for j in range(1, (len(random_outcome12_list) - i)):
            if random_outcome12_list[i][0] == random_outcome12_list[i + j][0] != 0:
                ...
                elif random_outcome12_list[i + j][1] == 5:
                    random_outcome12_list[i + j] = random_table_12_changed_5[0]
                    random_table_12_changed_5.remove(random_table_12_changed_5[0])
    for i in random_outcome12_list:
        random_value_12 = random_value_12 + i[3]

    # outcome for 6+1
    random_value_13 = 0
    random_outcome13_list = [random_table_6[0], random_table_1[0]]
    random_player_list_13 = []
    for i in random_outcome13_list:
        if i[0] != 0:
            random_player_list_13.append(i[0])
    random_table_13_changed_1 = random_table_1[2:]
    random_table_13_changed_6 = random_table_6[1:]
    for i in random_table_13_changed_1:
        if i[0] in random_player_list_13:
            random_table_13_changed_1.remove(i)
    for i in random_table_13_changed_6:
        if i[0] in random_player_list_13:
            random_table_13_changed_6.remove(i)
    for i in range(len(random_outcome13_list)):
        for j in range(1, (len(random_outcome13_list) - i)):
            if random_outcome13_list[i][0] == random_outcome13_list[i + j][0] != 0:
                ...
                elif random_outcome13_list[i + j][1] == 6:
                    random_outcome13_list[i + j] = random_table_13_changed_6[0]
                    random_table_13_changed_6.remove(random_table_13_changed_6[0])
    for i in random_outcome13_list:
        random_value_13 = random_value_13 + i[3]

    # outcome for 7
    random_value_14 = 0
    random_outcome14_list = [random_table_7[0]]
    random_player_list_14 = []
    for i in random_outcome14_list:
        if i[0] != 0:
            random_player_list_14.append(i[0])
    random_table_14_changed_7 = random_table_7[1:]
    for i in random_table_14_changed_7:
        if i[0] in random_player_list_14:
            random_table_14_changed_7.remove(i)
    for i in range(len(random_outcome14_list)):
        for j in range(1, (len(random_outcome14_list) - i)):
            if random_outcome14_list[i][0] == random_outcome14_list[i + j][0] != 0:
                if random_outcome14_list[i + j][1] == 7:
                    random_outcome14_list[i + j] = random_table_14_changed_7[0]
                    random_table_14_changed_7.remove(random_table_14_changed_7[0])
    for i in random_outcome14_list:
...
"""
bug = 4
average utility changed under truth-telling strategy: 2.9767
"""
