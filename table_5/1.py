...
for run in range(num_steps):
    ...
    for i in range(30):  # simulation period
                    ...
                    if slot[0][1] not in party_allocated_list:
                        if (
                            ...
                            if (
                                ...
                                seat_allocate[str(int(slot[0][7]) + i)] += int(
                                    slot[0][-1]
                                )
                    ...
                    if (slot[0][1] + slot[0][2]) not in party_allocated_list:
                        if (
                            ...
                            if (
                                ...
                                seat_allocate[str(int(slot[0][8]) + i)] += int(
                                    slot[0][-1]
                                )
        ...
        for VCG_party in VCG_party_list_sorted:
            for key, value in VCG_party.items():
                if key[-1] == "1":
                ...
                for m in range(len(outcomes_list)):
                    ...
                    if m == a:
                        ...
                        for p in outcome_m:
                            ...
                            if p[0][2] == "_":
                                report_table1 = [
                                    k for k in report_table1_copy if k[0][1] != p[0][1]
                                ]
                                report_table2 = [
                                    k for k in report_table2_copy if k[0][1] != p[0][1]
                                ]
                                report_table3 = [
                                    k for k in report_table3_copy if k[0][1] != p[0][1]
                                ]
                                report_table4 = [
                                    k for k in report_table4_copy if k[0][1] != p[0][1]
                                ]
                                report_table5 = [
                                    k for k in report_table5_copy if k[0][1] != p[0][1]
                                ]
                            elif p[0][2] != "_":
                                report_table1 = [
                                    k
                                    ...
                                    for o in range(len(outcomes_list)):
                                        if o == n:
                                            ...
                                            for second_outcome in outcomes_list[o]:
                                                second_seats_value += second_outcome[1]
                                            print(
                                                "second_best_value : ",
                                                second_seats_value,
                                            )
                                            monetary_transfer = -(
                                                seats_value - p[1] - second_seats_value
                                            )
                                            VCG_revenue = (
                                                VCG_revenue
                                                + p[0].count("A") * 10
